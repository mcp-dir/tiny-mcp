...
Tiny (Olist Tiny) segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Tiny (Olist)** | BR | ERP API provider (provedor dos dados do usuário) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [tiny@mcp.ai](mailto:tiny@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
